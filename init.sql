...
CREATE DATABASE
IF
NOT EXISTS leaf DEFAULT CHARACTER
...
VALUES
( 'leaf-segment-test', 1, 2000, 'Test leaf Segment Mode Get Id' );



-- ------------------------------
-- create sharding-jdbc
-- ------------------------------
CREATE DATABASE
IF
NOT EXISTS test_sharding DEFAULT CHARACTER
SET utf8 DEFAULT COLLATE utf8_bin;
USE test_sharding;
...
) ENGINE = INNODB AUTO_INCREMENT = 911643464158937089 CHARACTER
SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
...
SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
PRIMARY KEY ( `user_id` ) USING BTREE
) ENGINE = INNODB AUTO_INCREMENT = 911621097244327938 CHARACTER
SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
...
SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
PRIMARY KEY ( `user_id` ) USING BTREE
) ENGINE = INNODB AUTO_INCREMENT = 911656710223953921 CHARACTER
SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
...
SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
PRIMARY KEY ( `user_id` ) USING BTREE
) ENGINE = INNODB AUTO_INCREMENT = 911668726116384769 CHARACTER
SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
...
SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
PRIMARY KEY ( `user_id` ) USING BTREE
) ENGINE = INNODB AUTO_INCREMENT = 911668725424324610 CHARACTER 
SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
